export default {
    ...
    menuItems: {
        ...
        exit: "Quitter le portefeuille Guus GUI",
    ...
    notification: {
        ...
        warnings: {
            ...
            usingRemoteNode: "guusd introuvable, utilisation du nœud distant"
        }
    },
    placeholders: {
    ...
    strings: {
        ...
        guusBalance: "Solde",
        guusUnlockedBalance: "Solde débloqué",
        guusUnlockedShort: "Débloqué",
