export default {
    ...
    menuItems: {
        ...
        exit: "Saír da Carteira GUI Guus",
    ...
    notification: {
        ...
        warnings: {
            ...
            usingRemoteNode: "guusd não encontrado, utilizando nódulo remoto"
        }
    },
    placeholders: {
    ...
    strings: {
        ...
        guusBalance: "Saldo",
        guusUnlockedBalance: "Saldo desbloqueado",
        guusUnlockedShort: "Desbloqueado",
