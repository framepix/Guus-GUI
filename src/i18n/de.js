export default {
    ...
    menuItems: {
        ...
        exit: "Guus GUI Wallet schliessen",
    ...
    notification: {
        ...
        warnings: {
            ...
            usingRemoteNode: "lguusd nicht gefunden, benutze eine Remote Node"
        }
    },
    placeholders: {
    ...
    strings: {
        ...
        guusBalance: "Guthaben",
        guusUnlockedBalance: "frei verfügbares Guthaben",
        guusUnlockedShort: "frei verfügbar",
