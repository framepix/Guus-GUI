export default {
    ...
    menuItems: {
        ...
        exit: "Cerrar la interfaz del monedero Guus",
    ...
    notification: {
        ...
        warnings: {
            ...
            usingRemoteNode: "guusd no encontrado, utilizando nodo remoto"
        }
    },
    placeholders: {
    ...
    strings: {
        ...
        guusBalance: "Saldo",
        guusUnlockedBalance: "Saldo libre",
        guusUnlockedShort: "Libre",
