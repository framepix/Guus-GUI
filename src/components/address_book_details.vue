...
<q-modal v-model="isVisible" maximized class="address-book-details">
    ...
    <q-modal-layout v-if="mode == 'edit' || mode == 'new'">
        ...
        <div class="address-book-modal q-mx-md">
            <GuusField :label="$t('fieldLabels.address')" :error="$v.newEntry.address.$error">
                <q-input
            ...
            <GuusField :label="$t('fieldLabels.name')">
                <q-input
            ...
            <GuusField :label="$t('fieldLabels.paymentId')" :error="$v.newEntry.payment_id.$error" optional>
                <q-input
