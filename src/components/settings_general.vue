...
<div class="settings-general">
    ...
    <template v-if="config_daemon.type != 'remote'">
        <div class="row pl-sm">
            <GuusField class="col-8" :label="$t('fieldLabels.localDaemonIP')" disable>
                <q-input
            ...
            <GuusField class="col-4" :label="$t('fieldLabels.localDaemonPort') + '(RPC)'">
                <q-input
    ...
    <template v-if="config_daemon.type != 'local'">
        <div class="row q-mt-md pl-sm">
            <GuusField class="col-8" :label="$t('fieldLabels.remoteNodeHost')">
                <q-input
            ...
            <GuusField class="col-4" :label="$t('fieldLabels.remoteNodePort')">
                <q-input
    ...
    <div class="col q-mt-md pt-sm">
        <GuusField :label="$t('fieldLabels.dataStoragePath')" disable-hover>
        ...
        <GuusField :label="$t('fieldLabels.walletStoragePath')" disable-hover>
    ...
    <q-collapsible :label="$t('strings.advancedOptions')" header-class="q-mt-sm non-selectable row reverse advanced-options-label">
        ...
        <div class="row pl-sm q-mt-sm">
            <GuusField class="col-6" :label="$t('fieldLabels.daemonLogLevel')" :disable="is_remote">
            ...
            <GuusField class="col-6" :label="$t('fieldLabels.walletLogLevel')">
        ...
        <div class="row pl-sm q-mt-md">
            <GuusField class="col-3" :label="$t('fieldLabels.maxIncomingPeers')" :disable="is_remote">
            ...
            <GuusField class="col-3" :label="$t('fieldLabels.maxOutgoingPeers')" :disable="is_remote">
                <q-input v-model="config_daemon.out_peers" :placeholder="toString(daemon_defaults.out_peers)" :disable="is_remote" :dark="theme=='dark'"
                            type="number" :decimals="0" :step="1" min="-1" max="65535" hide-underline />
            </GuusField>
            <GuusField class="col-3" :label="$t('fieldLabels.limitUploadRate')" :disable="is_remote">
            ...
            <GuusField class="col-3" :label="$t('fieldLabels.limitDownloadRate')" :disable="is_remote">
        ...
        <div class="row pl-sm q-mt-md">
            <GuusField class="col-3" :label="$t('fieldLabels.daemonP2pPort')" :disable="is_remote">
            ...
            <GuusField class="col-3" :label="$t('fieldLabels.daemonZMQPort')" :disable="is_remote">
            ...
            <GuusField class="col-3" :label="$t('fieldLabels.internalWalletPort')">
                <q-input v-model="config.app.ws_bind_port" :placeholder="toString(defaults.app.ws_bind_port)" :dark="theme=='dark'"
                            float- type="number" :decimals="0" :step="1" min="1024" max="65535" hide-underline />
            </GuusField>
            <GuusField class="col-3" :label="$t('fieldLabels.walletRPCPort')" :disable="is_remote">
