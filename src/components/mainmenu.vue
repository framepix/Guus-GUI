...
<div>
    ...
    <q-modal minimized ref="aboutModal">
        <div class="about-modal">
            ...
            <img class="q-mb-md" src="statics/guus.svg" height="42" />

            <p class="q-my-sm">Wallet Version: v{{version}}</p>
            <p class="q-my-sm">Deaemon Version: v{{daemonVersion}}</p>
            <p class="q-my-sm">Copyright (c) 2024, Guus Project</p>
            <p class="q-my-sm">Copyright (c) 2018-2024, Oxen Project</p>
            <p class="q-my-sm">Copyright (c) 2018, Ryo Currency Project</p>
            <p class="q-my-sm">All rights reserved.</p>

            <div class="q-mt-md q-mb-lg external-links">
                <p>
                    <a @click="openExternal('https://guus.website/')" href="#">https://guus.website/</a>
                </p>
                <p>
                    <a @click="openExternal('https://t.me/guusproject')" href="#">Telegram</a> -
                    <a @click="openExternal('https://discordapp.com/invite/guusproject')" href="#">Discord</a> -
                    <a @click="openExternal('https://www.reddit.com/r/guusproject/')" href="#">Reddit</a> -
                    <a @click="openExternal('https://github.com/guusproject/guus-electron-wallet')" href="#">Github</a>
                </p>
            </div>
