    ...
    <q-modal class="key-image-modal" minimized v-model="modals.key_image.visible">
        ...
        <div class="q-ma-lg">
            ...
            <template v-if="modals.key_image.type == 'Export'">
                <GuusField class="q-mt-lg" :label="$t('fieldLabels.keyImages.exportDirectory')" disable-hover>
            ...
            <template v-if="modals.key_image.type == 'Import'">
                <GuusField class="q-mt-lg" :label="$t('fieldLabels.keyImages.importFile')" disable-hover>
