                    ...
                    <div class="row justify-between" style="max-width: 768px">
                        ...
                        <div class="infoBox">
                            <div class="infoBoxContent">
                                ...
                                <div class="value"><span><FormatGuus :amount="address.balance" /></span></div>
                            </div>
                        </div>

                        <div class="infoBox">
                            <div class="infoBoxContent">
                                <div class="text"><span>{{ $t("strings.guusUnlockedBalance") }}</span></div>
                                <div class="value"><span><FormatGuus :amount="address.unlocked_balance" /></span></div>
                            </div>
                        </div>
