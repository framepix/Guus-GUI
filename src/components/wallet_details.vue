...
<div class="column wallet-info">
    <div class="row justify-between items-center wallet-header guus-green">
    ...
    <div class="wallet-content">
        <div class="row justify-center">
            <div class="funds column items-center">
                <div class="balance">
                    <div class="text"><span>{{ $t("strings.guusBalance") }}</span></div>
                    <div class="value"><span><FormatGuus :amount="info.balance" /></span></div>
                </div>
                <div class="row unlocked">
                    <span>{{ $t("strings.guusUnlockedShort") }}: <FormatGuus :amount="info.unlocked_balance" /></span>
                </div>
            </div>
        </div>
