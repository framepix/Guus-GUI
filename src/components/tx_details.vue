            ...
            <div class="row justify-between" style="max-width: 768px">
                ...
                <div class="infoBox">
                    <div class="infoBoxContent">
                        ...
                        <div class="value"><span><FormatGuus :amount="tx.amount" raw-value /></span></div>
                    </div>
                </div>
                ...
                <div class="infoBox">
                    <div class="infoBoxContent">
                        ...
                        <div class="value"><span><FormatGuus :amount="tx.fee" raw-value /></span></div>
                    </div>
                </div>
                    ...
                    <template v-if="out_destinations">
                        <q-item class="q-px-none" v-for="destination in out_destinations">
                            <q-item-main>
                                ...
                                <q-item-tile sublabel><FormatGuus :amount="destination.amount" /></q-item-tile>
                            </q-item-main>
                            <q-context-menu>
                                <q-list link separator style="min-width: 150px; max-height: 300px;">
                                    <q-item v-close-overlay
