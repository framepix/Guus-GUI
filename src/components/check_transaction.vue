...
<div class="check-transaction">
    <div class="q-pa-md">
        ...
        <div>
            <GuusField :label="$t('fieldLabels.transactionId')" :error="$v.txid.$error">
            ...
            <GuusField class="q-mt-md" :label="$t('fieldLabels.address')" :error="$v.address.$error" optional>
            ...
            <GuusField class="q-mt-md" :label="$t('fieldLabels.message')" optional>
            ...
            <GuusField class="q-mt-md" :label="$t('fieldLabels.signature')" :error="$v.signature.$error">
        ...
        <div v-if="status.state.txid">
            ...
            <div class="q-mb-sm" v-if="status.state.received != null">
                ...
                <div><FormatGuus :amount="status.state.received" raw-value /></div>
            </div>
