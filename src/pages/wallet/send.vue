    ...
    <template v-else>
        <div class="q-pa-md">
            <div class="row gutter-md">
                ...
                <!-- Amount -->
                <div class="col-6">
                    <GuusField :label="$t('fieldLabels.amount')" :error="$v.newTx.amount.$error">
                ...
                <!-- Priority -->
                <div class="col-6">
                    <GuusField :label="$t('fieldLabels.priority')">
            ...
            <div class="col q-mt-sm">
                <GuusField :label="$t('fieldLabels.address')" :error="$v.newTx.address.$error">
            ...
            <!-- Payment ID -->
            <div class="col q-mt-sm">
                <GuusField :label="$t('fieldLabels.paymentId')" :error="$v.newTx.payment_id.$error" optional>
            ...
            <!-- Notes -->
            <div class="col q-mt-sm">
                <GuusField :label="$t('fieldLabels.notes')" optional>
            ...
            <div v-if="newTx.address_book.save">
                <GuusField :label="$t('fieldLabels.name')" optional>
                ...
                <GuusField class="q-mt-sm" :label="$t('fieldLabels.notes')" optional>
