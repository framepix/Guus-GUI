...
<q-page>
    <div class="row q-pt-sm q-mx-md q-mb-sm items-end non-selectable">
        ...
        <GuusField class="col-5 q-px-sm" :label="$t('fieldLabels.filter')">
        ...
        <GuusField class="col-2" :label="$t('fieldLabels.filterTransactionType')">
    ...
    data () {
        return {
            ...
            tx_type_options: [
                ...
                {label: this.$t("strings.transactions.types.frameNode"), value: "snode"},
