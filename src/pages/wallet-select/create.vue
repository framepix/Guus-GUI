...
<q-page class="create-wallet">
    <div class="fields q-mx-md q-mt-md">
        <GuusField :label="$t('fieldLabels.walletName')" :error="$v.wallet.name.$error">
            <q-input
                v-model="wallet.name"
                @keyup.enter="create"
        ...
        <GuusField :label="$t('fieldLabels.seedLanguage')">
            <q-select
        ...
        <GuusField :label="$t('fieldLabels.password')" optional>
            <q-input
