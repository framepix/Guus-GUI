...
<q-page>
    <div class="q-mx-md import-wallet">
        ...
        <GuusField :label="$t('fieldLabels.newWalletName')" :error="$v.wallet.name.$error">
            <q-input
                v-model="wallet.name"
        ...
        <GuusField :label="$t('fieldLabels.walletFile')" disable-hover :error="$v.wallet.path.$error">
            <q-input
                v-model="wallet.path"
        ...
        <GuusField :label="$t('fieldLabels.password')">
            <q-input
        ...
        <GuusField :label="$t('fieldLabels.confirmPassword')">
            <q-input
