...
<q-page>
    <div class="q-mx-md">
        <GuusField class="q-mt-md" :label="$t('fieldLabels.walletName')" :error="$v.wallet.name.$error">
            <q-input
                v-model="wallet.name"
        ...
        <GuusField class="q-mt-md" :label="$t('fieldLabels.mnemonicSeed')" :error="$v.wallet.seed.$error">
            <q-input
                v-model="wallet.seed"
        ...
        <div class="row items-end q-mt-md">
            <div class="col">
                <GuusField v-if="wallet.refresh_type=='date'" :label="$t('fieldLabels.restoreFromDate')">
                ...
                <GuusField v-else-if="wallet.refresh_type=='height'" :label="$t('fieldLabels.restoreFromBlockHeight')" :error="$v.wallet.refresh_start_height.$error">
        ...
        <GuusField class="q-mt-md" :label="$t('fieldLabels.password')">
            <q-input
        ...
        <GuusField class="q-mt-md" :label="$t('fieldLabels.confirmPassword')">
            <q-input
